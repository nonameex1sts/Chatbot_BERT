...
class ChatApplication:
    ...
    def _setup_main_window(self):
        ...
        self.window.configure(width=800, height=770, bg=BG_COLOR)

        # head label
        head_label = Label(self.window, bg=BG_COLOR, fg=TEXT_COLOR,
                           text=bot_name, font=FONT_BOLD, pady=10)
    ...
    def _insert_message(self, msg, sender):
        ...
        self.text_widget.tag_configure("chat_bubble", justify="right")
        self.text_widget.insert(END, msg1, "chat_bubble")  # Add "right" tag
